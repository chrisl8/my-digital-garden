...
![](/img/user/attachments/Pasted%20image%2020231202223736.png)
## Textures
...
![](/img/user/attachments/Pasted%20image%2020231203203353.png)
# Export STEP file
 ...
 ![](/img/user/attachments/Pasted%20image%2020231202224227.png)
...
![](/img/user/attachments/Pasted%20image%2020231203203452.png)
## Export
...
![](/img/user/attachments/Pasted%20image%2020231203203424.png)
...
Unity doesn't have built in glTF support, but this plugin appears to be official.
 ...
 - Use the + sign dropdown and pick "Add package by name..."
     - ![](/img/user/attachments/Pasted%20image%2020231203195941.png)
...
![](/img/user/attachments/Pasted%20image%2020231203203728.png)
...
![](/img/user/attachments/Pasted%20image%2020231203204058.png)
# Colliders
Each side of the model will have its own mesh instance.
![](/img/user/attachments/Pasted%20image%2020231203205008.png)
...
![](/img/user/attachments/Pasted%20image%2020231203210208.png)
Add a Mesh Collider to the selected entries
![](/img/user/attachments/Pasted%20image%2020231203205220.png)
Now is a good time to also drag any scripts that these meshes need onto the group
![](/img/user/attachments/Pasted%20image%2020231203210324.png)
